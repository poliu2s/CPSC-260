...
public:
    ...
    // POST: The employee object is destroyed.
    //
    // This one is defined to be virtual, so that if we destroy
    // a derived employee via an AbstractEmployee pointer, the correct
    // destructor suitable for the particular class will be called.
